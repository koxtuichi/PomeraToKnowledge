...
def call_gemini_api(prompt: str, model: str = "gemini-2.0-flash", response_mime_type: str = "text/plain", max_retries: int = 3) -> str:
    if not API_KEY:
...
def analyze_updated_state(master_graph: Dict[str, Any], current_diary_node: Dict[str, Any], diary_text: str = "") -> str:
    ...
    raw = call_gemini_api(prompt, model="gemini-2.0-flash", response_mime_type="application/json")
