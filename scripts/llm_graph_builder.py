...

{
  ...
  "blog_ideas": [
    {
      "title": "ブログ記事の仮タイトル（ブログアイディア::の内容そのまま）",
      "goal": "ブログゴール::があればその内容。なければnull",
      "memo": "同じ日記エントリ内にあるそのほかのメモ。なければnull",
      "readiness": "高/中/低（日記に書いた熱量・情報量から推測）"
    }
  ]
}
...
- 「blog_ideas」には日記中の「ブログアイディア::テーマ」という記法で書かれた項目を抽出してください。
  - 同じ日記に「ブログゴール::内容」が書かれていれば goal に入れてください。
  - LLMが自動生成する必要はありません。記法がなければ必ず空配列にしてください。
